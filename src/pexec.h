...
/* FIXME move this to pexec.c */
static int pexec(const char **argv, int fd_in, int fd_out)
{
	int i, fd_err;
	struct rlimit rl = {0};
...
static inline int pexec_hdlr_body(struct smtp_server_context *ctx, const char **argv,
